...
- Use correct launchctl commands for LaunchAgents ([#30](https://github.com/patrickserrano/runner-dashboard/pull/30))
- Add -H flag to sudo for correct HOME environment ([#29](https://github.com/patrickserrano/runner-dashboard/pull/29))
- Run svc.sh as runner user to fix permission denied error ([#26](https://github.com/patrickserrano/runner-dashboard/pull/26))
...
- Release v0.4.0 ([#23](https://github.com/patrickserrano/runner-dashboard/pull/23))
- Release v0.3.1
